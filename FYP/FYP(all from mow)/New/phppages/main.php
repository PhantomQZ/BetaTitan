...
<div id="container">
  ...
  <ul id="nav" style="display: none; ">
		...
		<ul id="slides" style="position: relative; ">
			...
			<li style="top: 0px; left: 0px; height: 20px; position: absolute; display: block; z-index: 5; opacity: 0.587512; "><a href="d2.php"><img src="dota2.jpg" alt="Harley Davidson Sportster"></a>"</li>
			<li style="position: absolute; z-index: 6; top: 0px; left: 0px; display: block; height: 20px; opacity: 0.412488; "><a href="BF4.php"><img src="battlefield.jpg" alt="Harley Davidson Sportster"></a></li>
...
<div id="size2">
	...
	<div id="game1">
	<h3 style="margin-left:20px;text-decoration: underline;">BATTLEFIELD 4 </h3><br><a href="BF4.php"><img src="b4box.jpg"style="margin-top:0px;margin-left:5px; height:250px;float:left;"/></a>
	<div id="game2">
	  <h3 style="margin-left:25px;margin-top:22px;text-decoration: underline;">SDO SEASON 3 </h3><br><a href="sdo.php"><img src="sdo-xS3.png" style="height:250px; width:300px; float:center; margin-left:-65px; margin-top:20px;" /></a>
	  <br>
	  </div>
	</div>
	<div id="game3">
	  <h3 style="margin-left:320px;margin-top:-22px;text-decoration: underline;">DOTA 2 </h3><br><a href="d2.php"><img src="dota.jpg" style="width:310px; height:210px; float:right;margin-top:33px;"/></a>
	</div>
