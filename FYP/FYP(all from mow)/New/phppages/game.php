...
$results = $conn->query("SELECT Game_name, Game_prequel, Game_Register_ID, Game_icon, Game_price, Game_homepage FROM game");
//Display fetched records as you please

$game =  '<ul class="products-wrp">';

while($row = $results->fetch_assoc()) {
$picture = $row['Game_icon'];
$page = $row['Game_homepage'];
$game .= <<<EOT
<li>
<form class="form-item">
<h4>{$row["Game_name"]}</h4>
<div><a href="$page"><img src="$picture"></a></div>
