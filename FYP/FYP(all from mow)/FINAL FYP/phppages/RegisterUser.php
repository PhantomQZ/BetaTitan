...
<form name="register" method="post" action="successfulregister.php" onSubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }">
...
<tr>
    ...
    <tr>
      <td>Agreements</td>
      <td style="text-align: left"><input type="checkbox" name="checkbox" id="agree">
        <a href="utc.php" target="_blank"> <b>Terms & Condition</b></a></td>
    </tr>
    ...
    <tr>
    	<th colspan="2"> Already have an account?<a href="loginpage.php"> Back to Homepage</a><a href="main.php"> </a></th>
    </tr>
