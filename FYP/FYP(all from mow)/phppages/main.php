...
<div id="size2">
	...
	<div id="game2">
	<h3 style="margin-left:90px;text-decoration: underline;">SDO SEASON 3 </h3><br><a href="sdo.php"><img src="sdo-xS3.png" style="height:250px; width:300px; float:center;" /></a>
	</div>
	<div id="game3">
	<h3 style="margin-left:320px;text-decoration: underline;">DOTA 2 </h3><br><a href="d2.php"><img src="dota.jpg" style="width:310px; height:210px; float:right;margin-top:20px;"/></a>
	</div>
