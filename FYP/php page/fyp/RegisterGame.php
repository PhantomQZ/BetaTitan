...
<br><select name="developer" width="250" style="width: 250px">
	<option value="Group 1">Group 1
	<option value="Group 2">Group 2
	<option value="Group 3">Group 3
	</select>
<br><br>
<b>Style*</b>
...
<br><input type="checkbox" name="mods" value="Mods"/>Mods
<br>
<br><br>
...
<?php 
	...
	{
	$Dev_Group = $_POST["developer"];
	$Game_Name = $_POST["GName"];
	$Sequel = $_POST["SequalName"];
	$Expansion = $_POST["ExpansionPack"];
	$Gstyle = $_POST["GStyle"];
	$Gtheme = $_POST["GTheme"];
	$Gtype = $_POST["GType"];
	$Redate = $_POST["REDate"];
	...
	(DEV_GROUP_NAME,GAME_NAME,GAME_PREQUEL,EXPANSION,GAME_STYLE,GAME_THEME,GAME_TYPE,GAME_HOMEPAGE,ARTICLES,MEDIA,MODS)
	values ('$Dev_Group','$Game_Name','$Sequel','$Expansion','$Gstyle','$Gtheme','$Gtype','$Homepage','$Articles','$Media','$Mods')");
	}
	?>
</div>
</div>
