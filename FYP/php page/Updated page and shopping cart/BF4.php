...
<div id="contentlock">
	<div id="topdiv">
		<div id="topdivHeader">
			...
			<div id="lockpurchase"><a href="cart.php?Game_Register_ID='2'"target="_blank"title="Purchase"><img Src="shop2.png"height="80"width="80"/></a></span>
			<span id="purc"><a href="cart.php?Game_Register_ID='2'"target="_blank"title="Purchase"><b>Add to Cart</b></a></span>
			<?php while($game = mysqli_fetch_object($result)) {?>
			<br><div id="gameprice"><b>RM <?php echo $game->Game_price; ?></b></div></div>
			<?php }?>
