...
echo $game;
			...
			<table width="105%" border="0" cellpadding="6">
				...
				<tr>
					<td>Total Rating
					<td><?php
					$takeratings = mysqli_fetch_assoc(mysqli_query($conn,"select * from tbl_rating where Game_Register_ID = '$gameid'"));
					...
					if(ratings!=NULL)
					{
					foreach($takeratings as $ratingsc)
						{
							$sum+= $ratingsc['rate'];
							$count++;
						}
