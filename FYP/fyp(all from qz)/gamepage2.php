		...
		<div>
		  ...
		  <?php
			if(isset($_POST['submit1']))
			{
				...
				,Game_type='$gtype',Release_date='$date',Game_homepage='$Homepage',Articles='$Articles',Media='$Media',Game_price='$gprice',Game_image='$gback'
				,Game_icon='$gicon', Game_boxshot='$gbox',Vid_link='$vid' where Game_Register_ID = '$gid'");
