...
$result = mysqli_query($conn, "select * from game where Game_Register_ID='2'");
...
<div class="item-box">
    <input name="Game_Register_ID" type="hidden" value="2">
...
?>
		...
		<body>
				...
				<div class="scrolls">
				<div class="imageDiv">
				<video id="my-video" class="video" width="320" height="150" controls><source src="Battlefield 4 Final Stand Official Gameplay Trailer.mp4"></video>
				<img class="fancybox" src="scr1.jpg"/>
				<img class="fancybox" src="scr2.jpg"/>
				<img class="fancybox" src="scr3.jpg"/>
				<img class="fancybox" src="scr4.jpg"/>
				<img class="fancybox" src="scr5.jpg"/>
				<img class="fancybox" src="scr6.jpg"/>
				<img class="fancybox" src="scr7.jpeg"/>
				<img class="fancybox" src="scr8.jpg"/>
				<img class="fancybox" src="scr9.jpg"/>
